...
(
    ...
    dic              varchar(255),
    email            varchar(255),
    firm_leader      varchar(255),
    firm_name        varchar(255),
    fve_area1        varchar(255),
    fve_area2        varchar(255),
    fve_area3        varchar(255),
    fve_area4        varchar(255),
    fve_capacity     varchar(255),
    fve_psc1         varchar(255),
    fve_psc2         varchar(255),
    fve_psc3         varchar(255),
    fve_psc4         varchar(255),
    fve_street1      varchar(255),
    fve_street2      varchar(255),
    fve_street3      varchar(255),
    fve_street4      varchar(255),
    ico              varchar(255),
...
(
    id                     int8 generated by default as identity,
    created_at             timestamp not null,
    notification_desc_type varchar(255),
    text                   varchar(255),
    fk_active_user         int8,
    fk_passive_user        int8,
    primary key (id)
);
...
(
    ...
    connected_fve_status           varchar(255),
    ...
    edr_contract_status            varchar(255),
    email                          varchar(255),
    ...
    hwsun_monitor_status           varchar(255),
    ico                            varchar(255),
    ...
    request_to_edr_status          varchar(255),
    ...
    sysel_agreement_status         varchar(255),
...
alter table if exists invite_entity
    add constraint FKlwgov19fnd2he876kua45lfks foreign key (user_id) references user_entity;
...
alter table if exists notification_entity
    add constraint FK4d6m5kfhxbd1g1x0oyl0iamfj foreign key (fk_active_user) references user_entity;
alter table if exists notification_entity
    add constraint FK4i3omv5w2hheyq20xct9eweu0 foreign key (fk_passive_user) references user_entity;
