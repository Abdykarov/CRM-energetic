...
public class ContactController {
    ...
    public ResponseEntity<Resource> getContactsCsv() {
        ...
        InputStreamResource file = contactService.getContactsCsv();
    ...
    public ResponseEntity<HttpStatus> importCsv(@RequestParam("file") MultipartFile file) throws IOException {
        contactService.importCsv(file, null);
    ...
    public ResponseEntity<Map<String, Object>> queryFilter(
            @RequestParam(required = true) String contactState,
        ...
        try {
            final Map<String, Object> response = contactService.queryFilter(null, contactState, filterType, name, surname, page, size);
