                                ...
                                <div className="col-lg-4 col-xl-4">
                                    <div className="card text-center">
                                        <div className="card-body">
                                            ...
                                            <h4 className="mb-0">Simon Blumel</h4>
                                            ...
                                            <div className="tab-content">
                                                ...
                                                <div className="tab-pane show active" id="attachments">
                                                    ...
                                                    <div className="row">
                                                        <h3>Supersmlouva</h3>
                                                        <button type="button"
                                                                className="btn btn-info waves-effect waves-light"><i
                                                            className="mdi mdi-cloud-outline me-1"></i> Vygenerovat supersmlouvu
                                                        </button>
                                                        <br/><br/>
                                                        <button type="button"
                                                                className="btn btn-dark waves-effect waves-light"><i
                                                            className="mdi mdi-cloud-outline me-1"></i> Zaslat supersmlouvu do mailu
                                                        </button>
                                                        <br/><br/>
                                                        <form action="/" method="post" className="dropzone dz-clickable"
