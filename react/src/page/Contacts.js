                                        ...
                                        <div className="table-responsive">
                                            <table className="table table-centered table-nowrap table-striped"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span className="badge bg-soft-success text-success">New</span>
                                                    </td>
                                                    <td>
                                                        Matěj Pošta
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="table-user">
                                                        <a href="javascript:void(0);" className="text-body fw-semibold">Petr Olšak</a>
                                                    </td>
                                                    <td>
                                                        13
                                                    </td>
                                                    ...
                                                    <td>petr.olšak@gmail.com</td>
                                                    <td>
                                                        <span className="badge bg-soft-secondary text-secondary">Použitý</span>
                                                    </td>
                                                    <td>
                                                        Matěj Pošta
                                                    </td>
